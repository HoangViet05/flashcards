...
export default function DocumentListPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16 sm:py-24 text-center animate-fade-in relative">
      ...
      <h2 className="text-2xl sm:text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-amber-200 to-orange-200 mt-4 mb-3">Tài liệu & tạo thẻ từ PDF</h2>
