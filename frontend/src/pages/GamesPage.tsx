...
export default function GamesPage() {
  ...
  return <div className="mx-auto max-w-5xl px-4 py-8"><h1 className="mb-6 text-2xl font-black text-white">🎮 Game củng cố từ vựng</h1>
    ...
    {state === 'done' && <div className="rounded-2xl border border-emerald-400/25 bg-emerald-400/[.06] p-8 text-center"><p className="mb-2 text-3xl">🎉</p><p className="text-sm text-slate-300">Hôm nay đã hoàn thành cả học lẫn chơi. Quay lại vào ngày mai nhé!</p></div>}
  </div>
}
